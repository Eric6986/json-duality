...
@Service
public class student_ords_documentsServiceImpl implements student_ords_documentsService {
    @Autowired
    private student_ords_documentsRepository student_ords_documentsRepository;
    ...
    public List<student_documents> findAll() {
        return student_ords_documentsRepository.findAll();
    }

    public Optional<student_documents> findById(Integer id) {

        return student_ords_documentsRepository.findById(id);
    }

    public student_documents saveOrUpdateStudent(student_documents student_documents) {

        return student_ords_documentsRepository.save(student_documents);
    }
    ...
    public void deleteStudentById(Integer id) {
        ...
        student_ords_documentsRepository.deleteById(id);
    }
}
